...
| 70 | Unreal Engine 5 | Built-in UE5.8 MCP | Remote HTTP | 3D network topology visualization — enterprise-grade rendering with Lumen lighting, spawn actors for devices/links, real-time health updates, camera fly-throughs (tool search mode) |
