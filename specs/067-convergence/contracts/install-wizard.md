...
- systemd: convergence-api/compose or k8s apply; host mesh/members unchanged except guardian ensure
- Summary line: `risk=<name> investigator=<id> deploy=<mode> convergence-api=<url>`
