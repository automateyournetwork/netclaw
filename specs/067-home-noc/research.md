...
**Decision**: Lift home-api under `netclaw/ui/home-api` (or `services/home-api`); HUD-native UI replaces EJS as primary.  
...
**Decision**: All PR work tracked in `specs/067-home-noc/tasks.md` via specify templates.  
