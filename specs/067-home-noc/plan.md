# Implementation Plan: NetClaw Home (067-home-noc)

**Branch**: `067-home-noc` | **Date**: 2026-07-24 | **Spec**: [spec.md](./spec.md)  
**Input**: Feature specification from `/specs/067-home-noc/spec.md`
...
| Spec-driven delivery | Pass | All work in `specs/067-home-noc/` via specify templates |
...
ui/home-api/              # moved Guardian Express API (PR2+)
deploy/home/
  docker-compose.yml
  k8s/
  adapters/
config/home-noc.example.yaml
scripts/lib/catalog.sh    # home components + profile
