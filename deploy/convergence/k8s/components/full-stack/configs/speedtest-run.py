#!/usr/bin/env python3
# NetClaw Convergence — Ookla speedtest runner (T072 full stack, K3s component)
# Pure-stdlib. Mirrors deploy/convergence/speedtest/run.py (Docker path) and
# k3s-observability-stack/k8s/observability/speedtest.yml runner logic.
