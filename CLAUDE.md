...
- Go (official HashiCorp Terraform MCP server) + terraform-mcp-server (official), Terraform CLI, HCP Terraform API (018-terraform-mcp-server)
- N/A (stateless proxy to Terraform APIs and local CLI) (018-terraform-mcp-server)
...
## Recent Changes
- 018-terraform-mcp-server: Added Go (official HashiCorp Terraform MCP server) + terraform-mcp-server (official), Terraform CLI, HCP Terraform API
